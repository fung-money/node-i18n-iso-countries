...
describe("i18n for iso 3166-1", function () {
  ...
  describe("getAlpha2Codes", function () {
    it("length", function () {
      assert.strictEqual(Object.keys(i18niso.getAlpha2Codes()).length, 251);
    });
  });
  describe("getAlpha3Codes", function () {
    it("length", function () {
      assert.strictEqual(Object.keys(i18niso.getAlpha3Codes()).length, 251);
    });
  });
  describe("getNumericCodes", function () {
    it("length", function () {
      assert.strictEqual(Object.keys(i18niso.getNumericCodes()).length, 251);
    });
  });
